...
func (m *MockStorager) FindAll(limit, offset int, order string, filters *user.FindUsersFilters) (*[]user.FindUserDTO, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAll", limit, offset, order, filters)
...
func (mr *MockStoragerMockRecorder) FindAll(limit, offset, order, filters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockStorager)(nil).FindAll), limit, offset, order, filters)
}
